<?php
/**
 * crossfit functions and definitions
 *
 * @package crossfit
 */
...
function crossfit_setup() {
	 ...
	 * If you're building a theme based on crossfit, use a find and replace
	 * to change 'crossfit' to the name of your theme in all the template files
	 */
...
function crossfit_register_custom_background() {
	...
	$args = apply_filters( 'crossfit_custom_background_args', $args );
 ...
 */
function crossfit_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'crossfit' ),
		'id'            => 'sidebar-1',
...
add_action( 'widgets_init', 'crossfit_widgets_init' );
...
function crossfit_scripts() {
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'crossfit-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20120202' );
	}
}
