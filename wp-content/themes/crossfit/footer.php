...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div id="footerNav">
			...
			<li><a href="localhost:8888/crossfitCal/getstarted">Get Started</a></li>  
			<li><a href="localhost:8888/crossfitCal/schedule">Schedule</a></li>
			<li><a href="localhost:8888/crossfitCal/successstories">Success Stories</a></li>
			<li><a href="localhost:8888/crossfitCal/gallery">Gallery</a></li>
			<li><a href="localhost:8888/crossfitCal/wod">WOD</a></li>
			<li><a href="localhost:8888/crossfitCal/contact">Contact</a></li>
			<li><a href="localhost:8888/crossfitCal/blog">Blog</a></li>
			</ul>
		</div>
